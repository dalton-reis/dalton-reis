Create one horizontal animation strip for Codex pet `furbot`, state `running-right`.
...
Identity: same pet in every frame: Match the supplied 3D Furbot model: blocky golden ochre cube head, two dark-blue F-shaped antennae, white rectangular eye panels with black pupils, thin muted-red mouth, deep navy rectangular torso with a darker blue F-shaped front marking, angular olive-green arms, cobalt-blue spherical hands, and a small ochre wheel/base. Preserve the low-poly 3D toy construction and exact color placement.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Low-poly hard-surface 3D model look; use the reference render and COLLADA material palette as authoritative. No red body or white head..
